package HerancaPolimorfismo.EnviandoMensagens;

public class Main {
    public static void main(String[] args) {
/*
Você está desenvolvendo um sistema de comunicação para uma plataforma de colaboração em
equipe. Esse sistema precisa lidar com diferentes cenários de envio de mensagens.
